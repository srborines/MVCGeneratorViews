...
class articulo_SHOWCURRENT{
	...
	?>
		<h1><?php echo $strings['Detalle'] . ' articulo' ?></h1>
		<form name='Form' action='articulo_Controller.php' method='post' onsubmit='comprobar()'>
			...
			EstadoA :<select name='EstadoA' required  readonly>
