	...
	?>
			<h1><?php echo $strings['Buscar'] . ' usuario_ponencia' ?></h1>
			<form name = 'Form' action='../Controller/usuario_ponencia_Controller.php' method='post' onsubmit = 'comprobar()'>
			...
			<a href='../Controller/usuario_ponencia_Controller.php'><?= $strings['Volver'] ?></a>
<?php
