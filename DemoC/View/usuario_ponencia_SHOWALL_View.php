...
class usuario_ponencia_SHOWALL{
	...
	function render(){
		...
		include 'Header.php';
?>
		<h1><?php echo $strings['Mostrar todos']. 'usuario_ponencia'; ?></h1>
		<a href='./usuario_ponencia_Controller.php?action=SEARCH'><img src='../View/Icons/search.png'></a></a>
		<a href='./usuario_ponencia_Controller.php?action=ADD'><img src='../View/Icons/add.png'></a></br></br>
		<br><br>
		<table border = 1>
<?php
