...
class articulo_ADD{
  ...
  ?>
    ...
    <form name = 'Form' action='../Controller/articulo_Controller.php' method='post' onsubmit='return comprobar_articulo()'>
			...
			FechaPublicacionR :<input type='date' name='FechaPublicacionR' size = '' value = '' onblur='esVacio(this)' ><br>
