...
class materia_SHOWCURRENT{
	...
	?>
		<h1><?php echo $strings['Detalle'] . ' materia' ?></h1>
		<form name='Form' action='materia_Controller.php' method='post' onsubmit='comprobar()'>
			...
			TipoM :<select name='TipoM' required  readonly>
			...
			TipoParticipacionM :<select name='TipoParticipacionM' required  readonly>
			...
			CuatrimestreM :<select name='CuatrimestreM' required  readonly>
