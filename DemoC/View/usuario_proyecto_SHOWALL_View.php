...
class usuario_proyecto_SHOWALL{
	...
	function render(){
		...
		include 'Header.php';
?>
		<h1><?php echo $strings['Mostrar todos']. 'usuario_proyecto'; ?></h1>
		<a href='./usuario_proyecto_Controller.php?action=SEARCH'><img src='../View/Icons/search.png'></a></a>
		<a href='./usuario_proyecto_Controller.php?action=ADD'><img src='../View/Icons/add.png'></a></br></br>
		<br><br>
		<table border = 1>
<?php
