...
<body class="skin-blue sidebar-mini" style="background-color: #ecf0f5;">
	...
	<div class="col-md-6">
		<form class="form-horizontal" id="installForm" action="./GenerarVistas.php?step=4" method="POST">
			...
			<div class="box box-solid ">
				<div class="box-header with-border">
					<h3 class="box-title"><?= $lang_array["header-box-3"] ?></h3>
				</div>
				<!-- form start -->
				<div class="box-body">
					<div class="alert alert-dismissible alert-info">
            <?= $lang_array['entities-text'] ?>
            <ul>
              <?php
          ...
          <div class="form-group">
            <label for="newinputDBUser" class="col-sm-2 control-label"><?= $lang_array["dbuser-3"] ?></label>
            <div class="col-sm-10">
              <input name="new_db_user" type="text" class="form-control" id="newinputDBUser" placeholder="<?= $lang_array["dbuserplaceholder-3"] ?>">
            </div>
          </div>
          <div class="form-group">
            <label for="newinputDBPassword" class="col-sm-2 control-label"><?= $lang_array["dbpass-3"] ?></label>
            <div class="col-sm-10">
              <input name="new_db_password" type="password" class="form-control" id="newinputDBPassword" placeholder="<?= $lang_array["dbpassplaceholder-3"] ?>">
            </div>
          </div>
					<div class="form-group">
						<label for="installDirectory" class="col-sm-2 control-label"><?= $lang_array["installDirectory-3"] ?></label>
						<div class="col-sm-10">
							<input name="install_directory" type="text" class="form-control" id="installDirectory" placeholder="<?= $lang_array["installDirectoryplaceholder-3"] ?>">
						</div>
					</div>
					<button type="submit" class="btn btn-success pull-right"><?= $lang_array["submit-3"] ?></button>
				</div>
				<!-- /.box-footer -->
			</div>
